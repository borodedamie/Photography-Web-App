        ...
        <div class="col-lg-12">
                <div class="card">
                        <div class="card-header">
                            <strong class="card-title">{{ $event->event_title }}</strong>
                        </div>
                        <div class="card-body card-block">
                            <form action="{{ route('admin.updateEvent', [$event->event_id])}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <input type="text" id="text-input" name="event_title" placeholder="" class="form-control" value="{{ $event->event_title }}">
                                    </div>
                                </div>
                                <div class="row form-group">
                                        <div class="col col-md-3" style="margin-left: 50px;">
                                            <label for="" class="form-control-label">Event Image</label>
                                        </div>
                                        <div class="col-12 col-lg-6">
                                            <img name = "" class ="img-responsive" alt=" No image" width="400px" src ="/img/home-blog/{{ $event->event_image}}">
                                        </div>
                                </div>
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-lg-6" style="margin-left: 50px;">
                                ...
                                <div class="row form-group">
                                        ...
                                        <div class="col-12 col-lg-6"><textarea name="event_description" id="textarea-input" rows="9" placeholder="Write a brief description about the event..." class="form-control">{{ $event->event_description }}</textarea></div>
                                </div>
                                <div class="card-footer" style="text-align: center;">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{ route('admin.event')}}" role="button">
